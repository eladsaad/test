class Admin::InteractiveVideosController < Admin::AdminController
  ...
  def index
    ...
    @admin_interactive_videos = @admin_interactive_videos.paginate(page: params[:page], per_page: 5)
  end
  ...
  private
    ...
    def admin_interactive_video_params
      params.require(:admin_interactive_video).permit(:name, :content, :language_code_id, :description)
    end
end
