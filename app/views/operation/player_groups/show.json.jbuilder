json.extract! @operation_player_group, :id, :operator_id, :reg_code, :screening_date, :name, :description, :player_organization_id, :mobile_station_code, :created_at, :updated_at
