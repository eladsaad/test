...
class Admin::VideosControllerTest < ActionController::TestCase
  ...
  test "should create admin_video" do
    assert_difference('Admin::Video.count') do
      post :create, admin_video: { description: @admin_video.description, language_code_id: @admin_video.language_code_id, name: @admin_video.name, thumbnail_url: @admin_video.thumbnail_url, url: @admin_video.url }
    end
  ...
  test "should update admin_video" do
    patch :update, id: @admin_video, admin_video: { description: @admin_video.description, language_code_id: @admin_video.language_code_id, name: @admin_video.name, thumbnail_url: @admin_video.thumbnail_url, url: @admin_video.url }
    assert_redirected_to admin_video_path(assigns(:admin_video))
  end
