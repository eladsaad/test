...
class OperatorsControllerTest < ActionController::TestCase
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post :create, operator: { country: @operator.country, email: @operator.email, name: @operator.name, reg_code_prefix: @operator.reg_code_prefix }
    end
  ...
  test "should update operator" do
    patch :update, id: @operator, operator: { country: @operator.country, email: @operator.email, name: @operator.name, reg_code_prefix: @operator.reg_code_prefix }
    assert_redirected_to operator_path(assigns(:operator))
  end
